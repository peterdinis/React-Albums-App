...
import {DivWrapper, HeaderOne, SearchInput, ButtonSearch, SearchedAlbum, AlbumName, InfoText, InfoNumber} from './AlbumSearch.styled';
...
function AlbumSearch() {
    ...
    return (
        <DivWrapper>
            ...
            <SearchInput type='text' onChange={handleChange} placeholder='Zadaj číslo albumu' />
            <ButtonSearch onClick={handleClick}>
                SUBMIT
            </ButtonSearch>

            <SearchedAlbum>
                <InfoNumber>Zadané číslo je: {albumId}</InfoNumber>
                <AlbumName>
